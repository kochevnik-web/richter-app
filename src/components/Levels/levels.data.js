    ...
    },
    {
        ...
        ansvers: [
            ...
            },
            {
                ...
                ans: 'Возраст и вес при подборе ОК играют большую роль, поэтому всегда надо помнить: ни один оральный контрацептив не универсален. Только квалифицированный специалист может учесть все нюансы и назначить правильный препарат, который сохранит здоровье и не даст побочек. Если ОК <a href="https://www.w-health.ru/?utm_source=medialeaks&utm_campaign=njz_2021" target="_blank">назначены грамотно</a> — это не только метод контрацепции, с их помощью можно облегчить ПМС и уменьшить выраженность боли. Но важно также знать, что существуют абсолютные противопоказания к приему оральных контрацептивов по состоянию здоровья.'
            },
        ],
        component: <Pills />
    },
